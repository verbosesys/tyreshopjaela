 ...
 * @author Verbose_User
 */
public class Service_Search extends javax.swing.JFrame {

    /**
     * Creates new form Battery_View
     */
    Essencials es;
    ...
    public Service_Search() {
        ...
        String[] headings = {"Service ID", "Service Name", "Service Type", "Cost", "Price.Gen"};
        es.customTBHEAD(jTable1, headings, 5, new java.awt.Color(224,224,224));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new Service_Search().setVisible(true);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private void showData(){
        try {
            ResultSet rs = DB.search("SELECT * FROM service");
            tbl.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
